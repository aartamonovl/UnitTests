...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(sum(2_147_483_640, 1));
...
*/
    ...
    public static int sum(int a, int b) {
        assert (((long) a + (long) b) < Integer.MAX_VALUE) : "Переполнение переменной";
        return a + b;
    }
    ...
    public static void happyNY() {
        ...
        assert !currentDateTime.equals("01/06/2024") : "Еще 2023 год :(";
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assert emmett.getName().equals("Emmett"): "Name should be Emmett";
        assert emmett.getArmorStrength() == 50: "Armor Strength should be 50";
        assert emmett.getWeapon().equals("sword"): "Weapon should be sword";
        assertThat(emmett.getBag())
                .isNotEmpty()
                .hasSize(3)
                .contains("Bow", "Axe", "Gold");
        assert emmett.isHuman(): "Hero should be a Human";
    }
